...
public class ExactSolution {
    ...
    public static void main(String[] args) {
        ...
        FileWriter writer;
        try{
            writer = new FileWriter("E:\\INTI (Degree)\\Theoretical Aspects Of Computer Science\\ExactSolution-master\\time.txt" , true);
        ...
        FileWriter writer2;
        try{
            writer2 = new FileWriter("E:\\INTI (Degree)\\Theoretical Aspects Of Computer Science\\ExactSolution-master\\cliqueResult.txt" , true);
